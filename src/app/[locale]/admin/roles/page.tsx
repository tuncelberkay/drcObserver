  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-8">
        <header className="flex items-center justify-between border-b border-slate-800 pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 mt-1">Enterprise mapping definitions segregating Group and User UI matrixes exclusively.</p>
            </div>
          </div>
        ...
        <div className="bg-indigo-500/10 border border-indigo-500/20 p-5 rounded-xl flex flex-col md:flex-row items-start gap-4 text-sm mb-8 shadow-inner">
          <Lock className="w-7 h-7 text-indigo-400 flex-shrink-0 mt-0.5 hidden sm:block" />
          <div className="flex-1">
            <strong className="text-indigo-400 block mb-1">Decoupled RBAC Execution Notice:</strong> 
            <p className="text-indigo-200/80 leading-relaxed max-w-4xl">
